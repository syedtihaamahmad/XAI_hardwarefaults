...
def parse_opt():
    ...
    parser.add_argument('--dl-json', type=str, default='coco2017/annotations/instances_val2017.json', help='path to datasets ground truth json file')
    parser.add_argument('--dl-img-root', type=str, default='coco2017/val2017', help='path to datasets images')
    parser.add_argument('--dl-ds-name', type=str, default='CoCo', help='dataset short name')
    parser.add_argument('--config-file', type=str, default='default_yolo.yml', help='name of default yml file - inside scenarios folder')
