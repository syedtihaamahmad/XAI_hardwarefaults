...
def obj_det_analysis(argv):
    ...
    exp_folder_paths = {"frcnn+CoCo":{
                        "neurons":{"path" :"/home/tawm9/pytorchalfi/result_files/VPU_test/frcnn_torchvision_1_trials/neurons_injs/per_batch/objDet_20221116-182544_1_faults_[1]_bits/coco/", "typ":"no_resil"},
