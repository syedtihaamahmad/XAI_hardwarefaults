...
class TestErrorModels_ImgClass:
    ...
    def __ptfi_dataloader(self):
        ...
        elif self.dl_attr.dl_dataset_name == 'cifar10':
            from alficore.dataloader.mnist_loader import CIFAR10_dataloader
            self.dataloader = CIFAR10_dataloader(dl_attr=self.dl_attr)
